...
Siendo el juego propuesto uno facil de desarrollar para principiantes, pero es cierto que si
no se llega a guardar de manera adecuada, puede haber problemas a la hora de recuperar los
archivos con los que se hayn llegado a trabajar. Y en ocasiones tocaria empezar desde 0 en el trabajo.
...
## Créditos
- Autor: Hernández de la Llama Valeria
